<div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade shadow-lg p-3 mb-5 bg-white rounded" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./img/Car_Dog_1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/Car_Dog_2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/Car_Dog_3.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/Car_Dog_4.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/Car_Dog_5.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <!-- Presentation -->
    <p>
        Centre situé au nord de Paris dans le 18eme arrondissement, nous proposons diverse services pour votre confort et le bien etre de votre chien ou de vos chiens.<br>
        Nous sommes une equipe de passionnée qui adorons les chiens et veillons principalement a leur bien etre.<br>
        Nous vous proposons diverses services avec une qualiter supérieure.
    </p>
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title">Coaching Bien-être</h5>
